...
$fetch = mysql_query("SELECT attraction_id_name, attraction_latitude , attraction_longitude FROM attraction ");
while ($row = mysql_fetch_array($fetch, MYSQL_ASSOC)) {
    $row_array['attraction_id_name'] = $row['attraction_id_name'];
    $row_array['attraction_latitude'] = $row['attraction_latitude'];
    $row_array['attraction_longitude'] = $row['attraction_longitude'];
